...
export default function Home() {
  ...
  return (
    <>
      <Navbar />
      <main className="min-h-screen bg-gradient-to-br from-blue-100 via-pink-100 to-purple-100">
        {/* HERO SECTION */}
        ...
        <section className="py-12 px-6">
          <div className="container mx-auto relative overflow-hidden rounded-3xl p-16 md:p-24 text-center text-black shadow-2xl">
