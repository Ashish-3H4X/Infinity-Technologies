        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-black-700">
              <li><NavLink href="/" className="hover:text-blue">Features</NavLink></li>
              <li><NavLink href="/pricing" className="hover:text-blue">Pricing</NavLink></li>
              <li><NavLink href="/services" className="hover:text-blue">Integrations</NavLink></li>
              <li><NavLink href="/blog" className="hover:text-blue">Projects</NavLink></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-black-700">
              <li><NavLink href="#" className="hover:text-blue">Documentation</NavLink></li>
              <li><NavLink href="#" className="hover:text-blue">Tutorials</NavLink></li>
              <li><NavLink href="/blog" className="hover:text-blue">Blog</NavLink></li>
              <li><NavLink href="#" className="hover:text-blue">Support</NavLink></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-black-700">
              <li><NavLink href="/about" className="hover:text-blue">About</NavLink></li>
              <li><NavLink href="/blog" className="hover:text-blue">Careers</NavLink></li>
              <li><NavLink href="/contact" className="hover:text-blue">Contact</NavLink></li>
              <li><NavLink href="/about" className="hover:text-blue">Partners</NavLink></li>
            </ul>
          </div>
        </div>
        <div className="my-5">
 ...
 {/* Bottom section */}
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 text-sm text-gray-600">
          ...
          <div className="flex gap-6">
            ...
            <NavLink href="/termsofservices" className="hover:text-blue">Terms of Service</NavLink>
            <NavLink href="/cookies" className="hover:text-blue">Cookies Settings</NavLink>
          </div>
        </div>
      </div>
    </motion.footer>
